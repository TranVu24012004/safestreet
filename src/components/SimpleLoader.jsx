...
const SimpleLoader = () => {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gray-50 z-50">
      <div className="mb-5">
        <img src="/logo.png" alt="Logo Inspectify" className="w-20 h-20 object-contain" />
      </div>
      <h1 className="text-gray-900 mt-2 mb-6 font-bold text-xl">Inspectify</h1>
      <p className="text-gray-800 mt-2 mb-6 font-medium">Giám sát mặt đường đơn giản hơn với AI</p>
